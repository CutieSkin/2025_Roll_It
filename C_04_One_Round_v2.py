...
# Roll the dice for the user and note if they qualify for double points
...
if user_points < comp_points:
    print("you start because your initial roll was less than computer\n")

# if the user and computer roll equal points, the user is player 1...
elif user_points == comp_points:
    print("The initial rolls were the same, user starts!")
...
while player_1_points < 13 and player_2_points < 13:
    ...
    # if the first persons score is over 13, end of the round
